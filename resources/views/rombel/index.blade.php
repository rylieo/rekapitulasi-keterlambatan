...
<h1 class="font-bold text-3xl  mb-10">Data Rombel</h1>
...
<div class="flex flex-row ...">
  ...
  <form action="{{ route('rombel.index') }}" class="ml-auto">
    <input type="text" name="rombels" placeholder="Search" class="bg-blue-100 h-10 px-5 pr-10 rounded-lg text-sm focus:outline-none" value="{{ request('rombels') }}">
            ...
            <tbody>
              ...
              @foreach ($rombels as $item)
                <tr class="border-b dark:border-neutral-500">
                  ...
                  <td class="whitespace-nowrap px-6 py-4">{{ $item['rombel'] }}</td>
                  <td class="flex mt-6">
                    <div>
